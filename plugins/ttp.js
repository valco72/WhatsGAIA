...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'gttp1 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 1" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/gerbang?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=acefafb873a9bcaa`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp2 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 2" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/smoketypography?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=acefafb873a9bcaa`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp3 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 3" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/pentakill?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=acefafb873a9bcaa`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp4 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 4" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/lolavatarglitch?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=acefafb873a9bcaa`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp5 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 5" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/lol?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=618a246c0fa31ba8`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp6 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 6" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/lolcover2?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=618a246c0fa31ba8`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp7 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 7" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/csgo?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=618a246c0fa31ba8`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp0 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 8" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/coveroverwatch?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=618a246c0fa31ba8`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp8 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 10" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/gradientavatar?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=0c6f586144a8decc`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp5 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 13" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/striking3d?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=0c6f586144a8decc`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp4 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 14" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/underwebmatrix?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=b4dc2c7bb5027031`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp3 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 15" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/bevel?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=b4dc2c7bb5027031`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gattp2 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 17" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/pokemon?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=b4dc2c7bb5027031`, { responseType: 'arraybuffer' })
    ...
    Asena.addCommand({ pattern: 'gttp9 ?(.*)', fromMe: true, desc: "Gaia TTP özel yazısı 18" }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.xteam.xyz/photooxy/warfacecover?text=${match[1].replace(/Ö/g, "%C3%96").replace(/ö/g, "%C3%B6").replace(/ü/g, "%C3%BC").replace(/Ü/g, "%C3%9C").replace(/Ğ/g, "%C4%9E").replace(/ğ/g, "%C4%9F").replace(/ş/g, "%C5%9F").replace(/Ş/g, "%C5%9E").replace(/ç/g, "%C3%A7").replace(/Ç/g, "%C3%87").replace(/ı/g, "%C4%B1").replace(/i/g, "%69").replace(/"/g, "%22").replace(/İ/g, "%C4%B0")}&APIKEY=5615985a6cbd1ddf`, { responseType: 'arraybuffer' })
