...
if (Config.WORKTYPE == 'private') {
    ...
    GAIA.addCommand({pattern: 'ffmpeg ?(.*)', fromMe: true, desc: Lang.FF_DESC}, (async (message, match) => {
    ...
    GAIA.addCommand({pattern: 'ffmpeg ?(.*)', fromMe: false, desc: Lang.FF_DESC, dontAddCommandList: true}, (async (message, match) => {
