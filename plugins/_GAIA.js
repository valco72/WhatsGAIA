...
if (Config.WORKTYPE == 'private') {
    ...
    GAIA.addCommand({pattern: 'GAIA ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    GAIA.addCommand({pattern: 'GAIA ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
