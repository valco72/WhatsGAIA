...
const Lang = Language.getString('_gaia');

if (Config.WORKTYPE == 'private') {

    Asena.addCommand({pattern: 'gaia ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'gaia ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
