...
if (Config.WORKTYPE == 'private') {
    GAIA.addCommand({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    GAIA.addCommand({pattern: 'sticker$', fromMe: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    GAIA.addCommand({pattern: 'sticker$', fromMe: true, desc: Lang.STICKER_DESC, dontAddCommandList: true}, (async (message, match) => {    
